...
I focus on architecture, correctness, performance, maintainability, and operational reliability. I can implement user interfaces when required, but UI/UX design is not my principal discipline: I am an engineer, not a designer.
...
The professional qualities underlying my soft- and hard-skills in teamwork, reliability, precision, rapid learning, and the ability to deliver strong results—are documented and confirmed in my employment references (*Arbeitszeugnisse*).
